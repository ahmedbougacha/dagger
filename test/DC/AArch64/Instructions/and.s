...
; CHECK-NEXT: [[V1:%.+]] = and i32 [[W17_0]], [[W18_0]]
; CHECK-NEXT: call void @llvm.dc.setreg.i32(i32 [[V1]], metadata !"W16")
and		w16, w17, w18
...
; CHECK-NEXT: [[V1:%.+]] = and i64 [[X17_0]], 4294967297
; CHECK-NEXT: call void @llvm.dc.setreg.i64(i64 [[V1]], metadata !"X16")
and	x16, x17, #0x100000001
...
; CHECK-NEXT: [[V1:%.+]] = and i64 [[X17_0]], [[X18_0]]
; CHECK-NEXT: call void @llvm.dc.setreg.i64(i64 [[V1]], metadata !"X16")
and		x16, x17, x18
