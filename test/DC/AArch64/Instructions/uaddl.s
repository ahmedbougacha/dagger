...
; CHECK-NEXT: [[V6:%.+]] = zext <4 x i16> [[V5]] to <4 x i32>
; CHECK-NEXT: [[V7:%.+]] = add <4 x i32> [[V3]], [[V6]]
...
; CHECK-NEXT: [[V6:%.+]] = zext <8 x i8> [[V5]] to <8 x i16>
; CHECK-NEXT: [[V7:%.+]] = add <8 x i16> [[V3]], [[V6]]
; CHECK-NEXT: [[V8:%.+]] = bitcast <8 x i16> [[V7]] to i128
; CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V8]], metadata !"Q16")
uaddl	v16.8h, v17.8b, v18.8b
