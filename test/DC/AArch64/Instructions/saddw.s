...
; CHECK-NEXT: [[V5:%.+]] = sext <4 x i16> [[V4]] to <4 x i32>
; CHECK-NEXT: [[V6:%.+]] = add <4 x i32> [[V2]], [[V5]]
; CHECK-NEXT: [[V7:%.+]] = bitcast <4 x i32> [[V6]] to i128
; CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V7]], metadata !"Q16")
saddw	v16.4s, v17.4s, v18.4h
...
; CHECK-NEXT: [[V5:%.+]] = sext <8 x i8> [[V4]] to <8 x i16>
; CHECK-NEXT: [[V6:%.+]] = add <8 x i16> [[V2]], [[V5]]
; CHECK-NEXT: [[V7:%.+]] = bitcast <8 x i16> [[V6]] to i128
; CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V7]], metadata !"Q16")
saddw	v16.8h, v17.8h, v18.8b
