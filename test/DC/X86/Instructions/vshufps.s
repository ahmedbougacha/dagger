...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> [[V7]], <8 x i32> <i32 2, i32 0, i32 8, i32 8, i32 6, i32 4, i32 12, i32 12>
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> [[V4]], <8 x i32> <i32 2, i32 0, i32 8, i32 8, i32 6, i32 4, i32 12, i32 12>
...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <4 x float> [[V2]], <4 x float> [[V7]], <4 x i32> <i32 2, i32 0, i32 4, i32 4>
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <4 x float> [[V2]], <4 x float> [[V4]], <4 x i32> <i32 2, i32 0, i32 4, i32 4>
