...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> [[V7]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 4, i32 12, i32 5, i32 13>
# CHECK-NEXT: [[V9:%.+]] = bitcast <8 x float> [[V8]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V9]], metadata !"YMM8")
vunpcklps	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> [[V4]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 4, i32 12, i32 5, i32 13>
# CHECK-NEXT: [[V6:%.+]] = bitcast <8 x float> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vunpcklps	%ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <4 x float> [[V2]], <4 x float> [[V7]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
# CHECK-NEXT: [[V9:%.+]] = bitcast <4 x float> [[V8]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V9]], metadata !"XMM8")
vunpcklps	2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <4 x float> [[V2]], <4 x float> [[V4]], <4 x i32> <i32 0, i32 4, i32 1, i32 5>
# CHECK-NEXT: [[V6:%.+]] = bitcast <4 x float> [[V5]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V6]], metadata !"XMM8")
vunpcklps	%xmm10, %xmm9, %xmm8
