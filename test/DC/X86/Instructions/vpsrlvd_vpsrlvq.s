...
# CHECK-NEXT: [[V9:%.+]] = lshr <8 x i32> [[V2]], [[V8]]
# CHECK-NEXT: [[V10:%.+]] = bitcast <8 x i32> [[V9]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V10]], metadata !"YMM8")
vpsrlvd	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = lshr <8 x i32> [[V2]], [[V4]]
# CHECK-NEXT: [[V6:%.+]] = bitcast <8 x i32> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpsrlvd	%ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: [[V6:%.+]] = inttoptr i64 [[V5]] to <4 x i64>*
# CHECK-NEXT: [[V7:%.+]] = load <4 x i64>, <4 x i64>* [[V6]], align 1
# CHECK-NEXT: [[V8:%.+]] = lshr <4 x i64> [[V2]], [[V7]]
# CHECK-NEXT: [[V9:%.+]] = bitcast <4 x i64> [[V8]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V9]], metadata !"YMM8")
vpsrlvq	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = lshr <4 x i64> [[V2]], [[V4]]
# CHECK-NEXT: [[V6:%.+]] = bitcast <4 x i64> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpsrlvq	%ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = lshr <2 x i64> [[V2]], [[V4]]
# CHECK-NEXT: [[V6:%.+]] = bitcast <2 x i64> [[V5]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V6]], metadata !"XMM8")
vpsrlvq	%xmm10, %xmm9, %xmm8
