...
# CHECK-NEXT: [[V8:%.+]] = fcmp ule <8 x float> [[V2]], [[V7]]
...
# CHECK-NEXT: [[V5:%.+]] = fcmp ule <8 x float> [[V2]], [[V4]]
...
# CHECK-NEXT: [[V8:%.+]] = fcmp ule <4 x float> [[V2]], [[V7]]
...
# CHECK-NEXT: [[V5:%.+]] = fcmp ule <4 x float> [[V2]], [[V4]]
