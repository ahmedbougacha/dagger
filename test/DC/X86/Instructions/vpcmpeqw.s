...
# CHECK-NEXT: [[V9:%.+]] = icmp eq <16 x i16> [[V2]], [[V8]]
...
vpcmpeqw	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = icmp eq <16 x i16> [[V2]], [[V4]]
...
vpcmpeqw	2(%r14,%r15,2), %xmm9, %xmm8
