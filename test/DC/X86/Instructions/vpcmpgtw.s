...
# CHECK-NEXT: [[V9:%.+]] = icmp sgt <16 x i16> [[V2]], [[V8]]
# CHECK-NEXT: [[V10:%.+]] = select <16 x i1> [[V9]], <16 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, <16 x i16> zeroinitializer
# CHECK-NEXT: [[V11:%.+]] = bitcast <16 x i16> [[V10]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V11]], metadata !"YMM8")
vpcmpgtw	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = icmp sgt <16 x i16> [[V2]], [[V4]]
# CHECK-NEXT: [[V6:%.+]] = select <16 x i1> [[V5]], <16 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, <16 x i16> zeroinitializer
# CHECK-NEXT: [[V7:%.+]] = bitcast <16 x i16> [[V6]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V7]], metadata !"YMM8")
vpcmpgtw	%ymm10, %ymm9, %ymm8
...
vpcmpgtw	2(%r14,%r15,2), %xmm9, %xmm8
