...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> [[V7]], <8 x i32> <i32 2, i32 10, i32 3, i32 11, i32 6, i32 14, i32 7, i32 15>
# CHECK-NEXT: [[V9:%.+]] = bitcast <8 x float> [[V8]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V9]], metadata !"YMM8")
vunpckhps	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> [[V4]], <8 x i32> <i32 2, i32 10, i32 3, i32 11, i32 6, i32 14, i32 7, i32 15>
# CHECK-NEXT: [[V6:%.+]] = bitcast <8 x float> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vunpckhps	%ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <4 x float> [[V2]], <4 x float> [[V7]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
# CHECK-NEXT: [[V9:%.+]] = bitcast <4 x float> [[V8]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V9]], metadata !"XMM8")
vunpckhps	2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <4 x float> [[V2]], <4 x float> [[V4]], <4 x i32> <i32 2, i32 6, i32 3, i32 7>
# CHECK-NEXT: [[V6:%.+]] = bitcast <4 x float> [[V5]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V6]], metadata !"XMM8")
vunpckhps	%xmm10, %xmm9, %xmm8
