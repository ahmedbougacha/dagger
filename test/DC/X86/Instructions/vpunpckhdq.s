...
# CHECK-NEXT: [[V9:%.+]] = shufflevector <8 x i32> [[V2]], <8 x i32> [[V8]], <8 x i32> <i32 2, i32 10, i32 3, i32 11, i32 6, i32 14, i32 7, i32 15>
# CHECK-NEXT: [[V10:%.+]] = bitcast <8 x i32> [[V9]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V10]], metadata !"YMM8")
vpunpckhdq	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <8 x i32> [[V2]], <8 x i32> [[V4]], <8 x i32> <i32 2, i32 10, i32 3, i32 11, i32 6, i32 14, i32 7, i32 15>
# CHECK-NEXT: [[V6:%.+]] = bitcast <8 x i32> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpunpckhdq	%ymm10, %ymm9, %ymm8
...
vpunpckhdq	2(%r14,%r15,2), %xmm9, %xmm8
