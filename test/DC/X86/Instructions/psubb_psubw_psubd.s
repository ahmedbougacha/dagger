...
# CHECK-NEXT: [[V9:%.+]] = sub <8 x i16> [[V2]], [[V8]]
# CHECK-NEXT: [[V10:%.+]] = bitcast <8 x i16> [[V9]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V10]], metadata !"XMM8")
psubw	2(%r14,%r15,2), %xmm8
