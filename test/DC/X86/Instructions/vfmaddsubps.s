...
vfmaddsubps	%xmm15, 2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmaddsubps	%ymm15, 2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmaddsubps	2(%r15,%r12,2), %xmm10, %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmaddsubps	2(%r15,%r12,2), %ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmaddsubps	%xmm11, %xmm10, %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmaddsubps	%ymm11, %ymm10, %ymm9, %ymm8

## VFMADDSUBPS4rrY_REV:	vfmaddsubps	%ymm11, %ymm10, %ymm9, %ymm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x35; .byte 0x5c; .byte 0xc2; .byte 0xb0

## VFMADDSUBPS4rr_REV:	vfmaddsubps	%xmm11, %xmm10, %xmm9, %xmm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x31; .byte 0x5c; .byte 0xc2; .byte 0xb0
