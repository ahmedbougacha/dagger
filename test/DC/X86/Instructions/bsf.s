...
# CHECK-NEXT: [[V7:%.+]] = call i16 @llvm.cttz.i16.i1(i16 [[V5]], i1 true)
...
# CHECK-NEXT: [[R8W_0:%.+]] = call i16 @llvm.dc.getreg.i16(metadata !"R8W")
# CHECK-NEXT: [[V2:%.+]] = call i16 @llvm.cttz.i16.i1(i16 [[R9W_0]], i1 true)
...
# CHECK-NEXT: [[V7:%.+]] = call i32 @llvm.cttz.i32.i1(i32 [[V5]], i1 true)
...
# CHECK-NEXT: [[R8D_0:%.+]] = call i32 @llvm.dc.getreg.i32(metadata !"R8D")
# CHECK-NEXT: [[V2:%.+]] = call i32 @llvm.cttz.i32.i1(i32 [[R9D_0]], i1 true)
...
# CHECK-NEXT: [[V7:%.+]] = call i64 @llvm.cttz.i64.i1(i64 [[V5]], i1 true)
...
# CHECK-NEXT: [[R11_0:%.+]] = call i64 @llvm.dc.getreg.i64(metadata !"R11")
# CHECK-NEXT: [[V2:%.+]] = call i64 @llvm.cttz.i64.i1(i64 [[RBX_0]], i1 true)
