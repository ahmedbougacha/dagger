...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vpermilps	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vpermilps	2(%r14,%r15,2), %xmm9, %xmm8
