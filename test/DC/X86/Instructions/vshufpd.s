...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <4 x double> [[V2]], <4 x double> [[V7]], <4 x i32> <i32 0, i32 5, i32 2, i32 6>
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <4 x double> [[V2]], <4 x double> [[V4]], <4 x i32> <i32 0, i32 5, i32 2, i32 6>
...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <2 x double> [[V2]], <2 x double> [[V7]], <2 x i32> <i32 0, i32 3>
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <2 x double> [[V2]], <2 x double> [[V4]], <2 x i32> <i32 0, i32 3>
