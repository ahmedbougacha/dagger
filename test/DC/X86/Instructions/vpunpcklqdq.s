...
# CHECK-NEXT: [[V8:%.+]] = shufflevector <4 x i64> [[V2]], <4 x i64> [[V7]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
# CHECK-NEXT: [[V9:%.+]] = bitcast <4 x i64> [[V8]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V9]], metadata !"YMM8")
vpunpcklqdq	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <4 x i64> [[V2]], <4 x i64> [[V4]], <4 x i32> <i32 0, i32 4, i32 2, i32 6>
# CHECK-NEXT: [[V6:%.+]] = bitcast <4 x i64> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpunpcklqdq	%ymm10, %ymm9, %ymm8
...
vpunpcklqdq	2(%r14,%r15,2), %xmm9, %xmm8
