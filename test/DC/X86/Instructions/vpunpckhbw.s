...
# CHECK-NEXT: [[V9:%.+]] = shufflevector <32 x i8> [[V2]], <32 x i8> [[V8]], <32 x i32> <i32 8, i32 40, i32 9, i32 41, i32 10, i32 42, i32 11, i32 43, i32 12, i32 44, i32 13, i32 45, i32 14, i32 46, i32 15, i32 47, i32 24, i32 56, i32 25, i32 57, i32 26, i32 58, i32 27, i32 59, i32 28, i32 60, i32 29, i32 61, i32 30, i32 62, i32 31, i32 63>
# CHECK-NEXT: [[V10:%.+]] = bitcast <32 x i8> [[V9]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V10]], metadata !"YMM8")
vpunpckhbw	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <32 x i8> [[V2]], <32 x i8> [[V4]], <32 x i32> <i32 8, i32 40, i32 9, i32 41, i32 10, i32 42, i32 11, i32 43, i32 12, i32 44, i32 13, i32 45, i32 14, i32 46, i32 15, i32 47, i32 24, i32 56, i32 25, i32 57, i32 26, i32 58, i32 27, i32 59, i32 28, i32 60, i32 29, i32 61, i32 30, i32 62, i32 31, i32 63>
# CHECK-NEXT: [[V6:%.+]] = bitcast <32 x i8> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpunpckhbw	%ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: [[V9:%.+]] = shufflevector <16 x i8> [[V2]], <16 x i8> [[V8]], <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
# CHECK-NEXT: [[V10:%.+]] = bitcast <16 x i8> [[V9]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V10]], metadata !"XMM8")
vpunpckhbw	2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <16 x i8> [[V2]], <16 x i8> [[V4]], <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
# CHECK-NEXT: [[V6:%.+]] = bitcast <16 x i8> [[V5]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V6]], metadata !"XMM8")
vpunpckhbw	%xmm10, %xmm9, %xmm8
