...
# CHECK-NEXT: [[V7:%.+]] = shufflevector <16 x i16> [[V6]], <16 x i16> undef, <16 x i32> <i32 2, i32 0, i32 0, i32 0, i32 4, i32 5, i32 6, i32 7, i32 10, i32 8, i32 8, i32 8, i32 12, i32 13, i32 14, i32 15>
# CHECK-NEXT: [[V8:%.+]] = bitcast <16 x i16> [[V7]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V8]], metadata !"YMM8")
vpshuflw	$2, 2(%rbx,%r14,2), %ymm8
...
# CHECK-NEXT: [[V3:%.+]] = shufflevector <16 x i16> [[V2]], <16 x i16> undef, <16 x i32> <i32 2, i32 0, i32 0, i32 0, i32 4, i32 5, i32 6, i32 7, i32 10, i32 8, i32 8, i32 8, i32 12, i32 13, i32 14, i32 15>
# CHECK-NEXT: [[V4:%.+]] = bitcast <16 x i16> [[V3]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V4]], metadata !"YMM8")
vpshuflw	$2, %ymm9, %ymm8
...
# CHECK-NEXT: [[V7:%.+]] = shufflevector <8 x i16> [[V6]], <8 x i16> undef, <8 x i32> <i32 2, i32 0, i32 0, i32 0, i32 4, i32 5, i32 6, i32 7>
# CHECK-NEXT: [[V8:%.+]] = bitcast <8 x i16> [[V7]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V8]], metadata !"XMM8")
vpshuflw	$2, 2(%rbx,%r14,2), %xmm8
...
# CHECK-NEXT: [[V3:%.+]] = shufflevector <8 x i16> [[V2]], <8 x i16> undef, <8 x i32> <i32 2, i32 0, i32 0, i32 0, i32 4, i32 5, i32 6, i32 7>
# CHECK-NEXT: [[V4:%.+]] = bitcast <8 x i16> [[V3]] to i128
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V4]], metadata !"XMM8")
vpshuflw	$2, %xmm9, %xmm8
