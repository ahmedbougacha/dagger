...
## VCVTTSD2SI64Zrm:	vcvttsd2si	2(%rbx,%r14,2), %r11
...
.byte 0x62; .byte 0x31; .byte 0xff; .byte 0x08; .byte 0x2c; .byte 0x9c; .byte 0x73; .byte 0x02; .byte 0x00; .byte 0x00; .byte 0x00
...
## VCVTTSD2SIZrm:	vcvttsd2si	2(%rbx,%r14,2), %r8d
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: [[RIP_0:%.+]] = call i64 @llvm.dc.getreg.i64(metadata !"RIP")
# CHECK-NEXT: [[V0:%.+]] = add i64 [[RIP_0]], 11
# CHECK-NEXT: call void @llvm.dc.setreg{{.*}} !"RIP")
...
.byte 0x62; .byte 0x31; .byte 0x7f; .byte 0x08; .byte 0x2c; .byte 0x84; .byte 0x73; .byte 0x02; .byte 0x00; .byte 0x00; .byte 0x00
