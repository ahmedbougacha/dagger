...
# CHECK-NEXT: [[V6:%.+]] = sitofp i64 [[V5]] to double
...
# CHECK-NEXT: [[V9:%.+]] = zext i64 [[V7]] to i128
# CHECK-NEXT: [[V10:%.+]] = and i128 [[V8]], -18446744073709551616
# CHECK-NEXT: [[V11:%.+]] = or i128 [[V9]], [[V10]]
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V11]], metadata !"XMM8")
cvtsi2sdq	2(%rbx,%r14,2), %xmm8
...
# CHECK-NEXT: call void @llvm.dc.setreg{{.*}} !"RIP")
# CHECK-NEXT: [[RBX_0:%.+]] = call i64 @llvm.dc.getreg.i64(metadata !"RBX")
# CHECK-NEXT: [[V1:%.+]] = sitofp i64 [[RBX_0]] to double
# CHECK-NEXT: [[V2:%.+]] = bitcast double [[V1]] to i64
# CHECK-NEXT: [[XMM8_0:%.+]] = call <4 x float> @llvm.dc.getreg.v4f32(metadata !"XMM8")
# CHECK-NEXT: [[V3:%.+]] = bitcast <4 x float> [[XMM8_0]] to i128
# CHECK-NEXT: [[V4:%.+]] = zext i64 [[V2]] to i128
# CHECK-NEXT: [[V5:%.+]] = and i128 [[V3]], -18446744073709551616
...
# CHECK-NEXT: [[V6:%.+]] = sitofp i32 [[V5]] to double
# CHECK-NEXT: [[V7:%.+]] = bitcast double [[V6]] to i64
# CHECK-NEXT: [[XMM8_0:%.+]] = call <4 x float> @llvm.dc.getreg.v4f32(metadata !"XMM8")
# CHECK-NEXT: [[V8:%.+]] = bitcast <4 x float> [[XMM8_0]] to i128
# CHECK-NEXT: [[V9:%.+]] = zext i64 [[V7]] to i128
...
# CHECK-NEXT: [[V1:%.+]] = sitofp i32 [[R9D_0]] to double
# CHECK-NEXT: [[V2:%.+]] = bitcast double [[V1]] to i64
# CHECK-NEXT: [[XMM8_0:%.+]] = call <4 x float> @llvm.dc.getreg.v4f32(metadata !"XMM8")
# CHECK-NEXT: [[V3:%.+]] = bitcast <4 x float> [[XMM8_0]] to i128
# CHECK-NEXT: [[V4:%.+]] = zext i64 [[V2]] to i128
