...
# CHECK-NEXT: [[V5:%.+]] = bitcast i256 [[V4]] to <8 x float>
# CHECK-NEXT: [[V6:%.+]] = bitcast <8 x float> [[V5]] to <4 x i64>
# CHECK-NEXT: [[V7:%.+]] = and <4 x i64> [[V3]], [[V6]]
