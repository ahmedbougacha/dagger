...
# CHECK-NEXT: [[V9:%.+]] = icmp eq <32 x i8> [[V2]], [[V8]]
...
vpcmpeqb	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = icmp eq <32 x i8> [[V2]], [[V4]]
...
vpcmpeqb	2(%r14,%r15,2), %xmm9, %xmm8
