...
# CHECK-NEXT: [[V8:%.+]] = icmp sgt <4 x i64> [[V2]], [[V7]]
...
vpcmpgtq	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = icmp sgt <4 x i64> [[V2]], [[V4]]
...
vpcmpgtq	2(%r14,%r15,2), %xmm9, %xmm8
