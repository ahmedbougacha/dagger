...
vfnmsubpd	%ymm15, 2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfnmsubpd	2(%r15,%r12,2), %ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfnmsubpd	%ymm11, %ymm10, %ymm9, %ymm8

## VFNMSUBPD4Yrr_REV:	vfnmsubpd	%ymm11, %ymm10, %ymm9, %ymm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x35; .byte 0x7d; .byte 0xc2; .byte 0xb0
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfnmsubpd	%xmm15, 2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfnmsubpd	2(%r15,%r12,2), %xmm10, %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfnmsubpd	%xmm11, %xmm10, %xmm9, %xmm8

## VFNMSUBPD4rr_REV:	vfnmsubpd	%xmm11, %xmm10, %xmm9, %xmm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x31; .byte 0x7d; .byte 0xc2; .byte 0xb0
