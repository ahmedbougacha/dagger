...
vfmsubss	%xmm15, 2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubss	2(%r15,%r12,2), %xmm10, %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubss	%xmm11, %xmm10, %xmm9, %xmm8

## VFMSUBSS4rr_REV:	vfmsubss	%xmm11, %xmm10, %xmm9, %xmm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x31; .byte 0x6e; .byte 0xc2; .byte 0xb0
