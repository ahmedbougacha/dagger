...
# CHECK-NEXT: store float [[V3]], float* [[V7]], align 1
vmovss	%xmm13, 2(%r11,%rbx,2)
...
# CHECK-NEXT: [[V8:%.+]] = zext i32 [[V6]] to i128
# CHECK-NEXT: [[V9:%.+]] = and i128 [[V7]], -4294967296
# CHECK-NEXT: [[V10:%.+]] = or i128 [[V8]], [[V9]]
# CHECK-NEXT: call void @llvm.dc.setreg.i128(i128 [[V10]], metadata !"XMM8")
vmovss	2(%rbx,%r14,2), %xmm8
...
vmovss	%xmm10, %xmm9, %xmm8

## VMOVSSrr_REV:	vmovss	%xmm10, %xmm9, %xmm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x41; .byte 0x32; .byte 0x11; .byte 0xd0
