...
# CHECK-NEXT: [[V4:%.+]] = inttoptr i64 [[V3]] to i8*
# CHECK-NEXT: [[V5:%.+]] = load i8, i8* [[V4]], align 1
# CHECK-NEXT: [[V6:%.+]] = sext i8 [[V5]] to i32
# CHECK-NEXT: call void @llvm.dc.setreg.i32(i32 [[V6]], metadata !"R8D")
movsbl	2(%rbx,%r14,2), %r8d
...
# CHECK-NEXT: [[V1:%.+]] = sext i16 [[R9W_0]] to i32
...
# CHECK-NEXT: [[V1:%.+]] = sext i8 [[SPL_0]] to i32
# CHECK-NEXT: call void @llvm.dc.setreg.i32(i32 [[V1]], metadata !"R8D")
movsbl	%spl, %r8d
...
# CHECK-NEXT: [[V6:%.+]] = sext i32 [[V5]] to i64
# CHECK-NEXT: call void @llvm.dc.setreg.i64(i64 [[V6]], metadata !"R11")
movslq	2(%rbx,%r14,2), %r11
...
# CHECK-NEXT: [[V4:%.+]] = inttoptr i64 [[V3]] to i8*
# CHECK-NEXT: [[V5:%.+]] = load i8, i8* [[V4]], align 1
# CHECK-NEXT: [[V6:%.+]] = sext i8 [[V5]] to i64
# CHECK-NEXT: call void @llvm.dc.setreg.i64(i64 [[V6]], metadata !"R11")
movsbq	2(%rbx,%r14,2), %r11
...
# CHECK-NEXT: call void @llvm.dc.setreg{{.*}} !"RIP")
# CHECK-NEXT: [[R9W_0:%.+]] = call i16 @llvm.dc.getreg.i16(metadata !"R9W")
# CHECK-NEXT: [[V1:%.+]] = sext i16 [[R9W_0]] to i64
...
# CHECK-NEXT: [[V1:%.+]] = sext i32 [[R9D_0]] to i64
# CHECK-NEXT: call void @llvm.dc.setreg.i64(i64 [[V1]], metadata !"R11")
movslq	%r9d, %r11
...
# CHECK-NEXT: call void @llvm.dc.setreg{{.*}} !"RIP")
# CHECK-NEXT: [[SPL_0:%.+]] = call i8 @llvm.dc.getreg.i8(metadata !"SPL")
# CHECK-NEXT: [[V1:%.+]] = sext i8 [[SPL_0]] to i64
# CHECK-NEXT: call void @llvm.dc.setreg.i64(i64 [[V1]], metadata !"R11")
movsbq	%spl, %r11
