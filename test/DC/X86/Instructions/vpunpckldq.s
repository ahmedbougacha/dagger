...
# CHECK-NEXT: [[V9:%.+]] = shufflevector <8 x i32> [[V2]], <8 x i32> [[V8]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 4, i32 12, i32 5, i32 13>
# CHECK-NEXT: [[V10:%.+]] = bitcast <8 x i32> [[V9]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V10]], metadata !"YMM8")
vpunpckldq	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <8 x i32> [[V2]], <8 x i32> [[V4]], <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 4, i32 12, i32 5, i32 13>
# CHECK-NEXT: [[V6:%.+]] = bitcast <8 x i32> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpunpckldq	%ymm10, %ymm9, %ymm8
...
vpunpckldq	2(%r14,%r15,2), %xmm9, %xmm8
