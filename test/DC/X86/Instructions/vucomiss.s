...
# CHECK-NEXT: [[V9:%.+]] = fcmp ueq float [[V3]], [[V8]]
# CHECK-NEXT: [[V10:%.+]] = fcmp uno float [[V3]], [[V8]]
# CHECK-NEXT: [[V11:%.+]] = fcmp ult float [[V3]], [[V8]]
...
# CHECK-NEXT: [[V7:%.+]] = fcmp ueq float [[V3]], [[V6]]
# CHECK-NEXT: [[V8:%.+]] = fcmp uno float [[V3]], [[V6]]
# CHECK-NEXT: [[V9:%.+]] = fcmp ult float [[V3]], [[V6]]
