...
vfmsubaddps	%xmm15, 2(%r14,%r15,2), %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubaddps	%ymm15, 2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubaddps	2(%r15,%r12,2), %xmm10, %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubaddps	2(%r15,%r12,2), %ymm10, %ymm9, %ymm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubaddps	%xmm11, %xmm10, %xmm9, %xmm8
...
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
vfmsubaddps	%ymm11, %ymm10, %ymm9, %ymm8

## VFMSUBADDPS4rrY_REV:	vfmsubaddps	%ymm11, %ymm10, %ymm9, %ymm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x35; .byte 0x5e; .byte 0xc2; .byte 0xb0

## VFMSUBADDPS4rr_REV:	vfmsubaddps	%xmm11, %xmm10, %xmm9, %xmm8
# CHECK-LABEL: call void @llvm.dc.startinst
# CHECK-NEXT: call void @llvm.trap()
# CHECK-NEXT: unreachable
.byte 0xc4; .byte 0x43; .byte 0x31; .byte 0x5e; .byte 0xc2; .byte 0xb0
