...
# CHECK-NEXT: [[V9:%.+]] = shufflevector <16 x i16> [[V2]], <16 x i16> [[V8]], <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27>
# CHECK-NEXT: [[V10:%.+]] = bitcast <16 x i16> [[V9]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V10]], metadata !"YMM8")
vpunpcklwd	2(%r14,%r15,2), %ymm9, %ymm8
...
# CHECK-NEXT: [[V5:%.+]] = shufflevector <16 x i16> [[V2]], <16 x i16> [[V4]], <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27>
# CHECK-NEXT: [[V6:%.+]] = bitcast <16 x i16> [[V5]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V6]], metadata !"YMM8")
vpunpcklwd	%ymm10, %ymm9, %ymm8
...
vpunpcklwd	2(%r14,%r15,2), %xmm9, %xmm8
