...
# CHECK-NEXT: [[V6:%.+]] = shufflevector <8 x float> [[V5]], <8 x float> undef, <8 x i32> <i32 0, i32 0, i32 2, i32 2, i32 4, i32 4, i32 6, i32 6>
# CHECK-NEXT: [[V7:%.+]] = bitcast <8 x float> [[V6]] to i256
# CHECK-NEXT: call void @llvm.dc.setreg.i256(i256 [[V7]], metadata !"YMM8")
vmovsldup	2(%rbx,%r14,2), %ymm8
...
# CHECK-NEXT: [[V3:%.+]] = shufflevector <8 x float> [[V2]], <8 x float> undef, <8 x i32> <i32 0, i32 0, i32 2, i32 2, i32 4, i32 4, i32 6, i32 6>
