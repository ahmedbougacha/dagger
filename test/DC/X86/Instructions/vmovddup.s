...
# CHECK-NEXT: [[V6:%.+]] = shufflevector <4 x double> [[V5]], <4 x double> undef, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
...
# CHECK-NEXT: [[V3:%.+]] = shufflevector <4 x double> [[V2]], <4 x double> undef, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
